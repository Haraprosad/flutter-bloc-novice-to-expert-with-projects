...
class TimerBloc extends Bloc<TimerEvent,TimerState>{
  ...
  FutureOr<void> _onStarted(TimerStarted event, Emitter<TimerState> emit) {
    ...
    _tickerSubscription?.cancel();
    //to get stream sended data StreamSubscription listen method is used.
    _tickerSubscription = _ticker.tick(ticks: event.duration).listen((event)=>add(TimerTicked(duration: event)));
  }
